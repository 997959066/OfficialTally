...
public class LoanServiceImplTest extends Base {
...
//        loan.setSettlement(1);
        List<Loan> list = loanService.list(loan);
    ...
    public void append() {
        ...
        loan.setSettlement(1);
        loan.setUserId(1);
        int isOk = loanService.append(loan);
    ...
    public void settlement() {
        int isOk = loanService.settlement(19, 0);
        System.out.println(isOk);
    }

    @Test
    public void delete() {
        int isOk = loanService.delete(20);
        System.out.println(isOk);
    }
    ...
    public void update() {
        ...
        loan.setUserId(2);
        int isOk = loanService.update(loan);
        System.out.println(isOk);
    }
}